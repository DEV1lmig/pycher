export function WelcomeHeader() {
    return (
      <div className="bg-gradient-to-r from-[#312a56] to-[#1a1433] rounded-lg p-6">
        <h1 className="text-3xl font-bold mb-2">¡Bienvenido de vuelta, Carlos!</h1>
        <p className="text-gray-300 mb-4">Continúa tu viaje de aprendizaje en Python. Tienes 3 cursos en progreso.</p>
