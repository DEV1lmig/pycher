...
import desktopPic from "@/assets/images/desktop.png"
    ...
    <div className="flex min-h-screen">
      <div className="hidden lg:flex lg:w-[60%] relative p-12 flex-col justify-between">
        ...
        <h1 className="text-4xl font-bold text-white font-gelasio flex flex-col items-end -mt-60 text-right">
            <p>Keep learning with us at</p>
            <p className="text-secondary">Py</p>
            <p>Cher</p>
            Sign in!
        </h1>
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mt-2">
              Sign in to continue with your adventure in python
            </p>
          </div>
          ...
          <p className="text-center text-muted-foreground">
            ...
            <Link href="/auth/register" className="text-[#00b894] hover:underline">
              Sign up
            </Link>
          </p>
        </div>
